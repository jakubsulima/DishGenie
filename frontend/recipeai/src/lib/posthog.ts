...
type AnalyticsEventName =
  ...
  | "shopping_to_fridge_review_opened"
  | "shopping_to_fridge_confirmed"
  | "shopping_to_fridge_failed"
  | "fridge_item_added"
  | "fridge_item_added_barcode"
  | "fridge_quick_adjusted"
  | "fridge_quick_adjust_failed"
  | "fridge_operation_undone"
  | "barcode_session_started"
  | "barcode_detected"
  | "barcode_session_confirmed"
  | "barcode_lookup_failed"
  | "barcode_session_confirm_failed"
